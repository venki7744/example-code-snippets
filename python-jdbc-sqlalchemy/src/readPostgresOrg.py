...
con=sqlalchemy.create_engine("jdbcapi+pgjdbc://{}:{}@{}/{}".format('postgres', 'postgres', 'localhost', 'sqlalchemyTest'),driver_path="D:\Learn\ApacheBeam\jar\pgjdbc_combined-1.0-SNAPSHOT-jar-with-dependencies.jar").execution_options(isolation_level='AUTOCOMMIT')
con=con.raw_connection()
wcon=sqlalchemy.create_engine("jdbcapi+pgjdbc://{}:{}@{}/{}".format('postgres', 'postgres', 'localhost', 'sqlalchemyTest'),driver_path="D:\Learn\ApacheBeam\jar\pgjdbc_combined-1.0-SNAPSHOT-jar-with-dependencies.jar")
...
#print(readChunk)
    ...
    readChunk.to_sql('testtableout10',wcon,schema='public',if_exists='append',index=False,chunksize=15000,method='multi')
